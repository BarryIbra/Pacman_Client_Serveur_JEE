...
public class Agent {
    ...
    public void setPosition(PositionAgent pos) { position = pos; }

    public Strategy getStrategy(){ return strategy; }
    public void setStrategy(Strategy strategy){ this.strategy = strategy;}

    public int  getLives() { return numberOfLives; } 
    public void removeOneLife(){ numberOfLives--;   }
    public void addOneLife()   { numberOfLives++;   }
    public void restartLives() { numberOfLives = 1; }
